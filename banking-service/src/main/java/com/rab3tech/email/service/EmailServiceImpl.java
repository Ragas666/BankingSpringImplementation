...
public class EmailServiceImpl implements EmailService{
	...
	@Async("threadPool")
	@Override
	public String sendAccountStmt(EmailVO mail) {
		 ...
		 try {
		        ...
		        String fromAccount = "12312444";
		        if(customerTransactionVOs.size()>0)						// fetching fromAccount details from the list 
		        {
		        	customerTransactionVOs.get(0).getFromAccount();      // get(0) means taking first record
		        }
		       ...
		       props.put("fromAccount", fromAccount);
		        ...
		        helper.setSubject("Your account statements details");
